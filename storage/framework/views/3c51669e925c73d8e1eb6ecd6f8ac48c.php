...
<body class="bg-gray-100 font-sans">
        ...
        <aside class="w-64 sidebar-bg text-white flex-shrink-0">
            <div class="p-6 text-center border-b sidebar-logo-border">
                ...
                <?php if(setting('institute_logo_url')): ?>
                    <img src="<?php echo e(setting('institute_logo_url')); ?>" alt="Logo" class="w-20 h-20 rounded-full mx-auto mb-3 object-cover shadow-lg">
                <?php endif; ?>
    ...
    ?>
    <span class="sidebar-logo-highlight"><?php echo e($firstWord); ?></span><?php echo e($secondPart); ?>
                ...
                <ul class="space-y-2 px-4">
                    ...
                    <li>
                        <a href="<?php echo e(route('students.index')); ?>"
                           class="sidebar-item flex items-center space-x-3 px-4 py-3 rounded-lg
                                   <?php echo e(request()->routeIs('students.*') ? 'active' : ''); ?>">
                    ...
                    <li>
                        <a href="<?php echo e(route('batches.index')); ?>"
                           class="sidebar-item flex items-center space-x-3 px-4 py-3 rounded-lg
                                   <?php echo e(request()->routeIs('batches.*') ? 'active' : ''); ?>">
                    ...
                    <li x-data="{ open: <?php echo e(request()->routeIs('attendance.*') ? 'true' : 'false'); ?> }">
                        <button @click="open = !open" class="sidebar-item flex items-center justify-between w-full px-4 py-2 text-left rounded-lg <?php echo e(request()->routeIs('attendance.*') ? 'active' : ''); ?>">
                        ...
                        <div x-show="open" x-transition class="mt-2 space-y-2 pl-10">
                            <a href="<?php echo e(route('attendance.index')); ?>" class="sidebar-dropdown-item block px-3 py-2 rounded-md text-sm font-medium <?php echo e(request()->routeIs('attendance.index') ? 'active' : ''); ?>">
                                Mark Attendance
                            </a>
                            <a href="<?php echo e(route('attendance.report')); ?>" class="sidebar-dropdown-item block px-3 py-2 rounded-md text-sm font-medium <?php echo e(request()->routeIs('attendance.report') ? 'active' : ''); ?>">
                                View Report
                            </a>
                            
                        <a href="<?php echo e(route('attendance.edit')); ?>" class="sidebar-dropdown-item block px-3 py-2 rounded-md text-sm font-medium <?php echo e(request()->routeIs('attendance.edit') ? 'active' : ''); ?>">
                    ...
                    <li x-data="{ open: <?php echo e(request()->routeIs('fees.*') ? 'true' : 'false'); ?> }">
                        <button @click="open = !open" class="sidebar-item flex items-center justify-between w-full px-4 py-2 text-left rounded-lg <?php echo e(request()->routeIs('fees.*') ? 'active' : ''); ?>">
                            <span class="flex items-center space-x-3">
                        ...
                        <!-- Dropdown Menu -->
                        <div x-show="open" x-transition class="mt-2 space-y-2 pl-10">
                            <a href="<?php echo e(route('fees.index')); ?>" class="sidebar-dropdown-item block px-3 py-2 rounded-md text-sm font-medium <?php echo e(request()->routeIs('fees.index') ? 'active' : ''); ?>">
                                Fee Ledger
                            </a>
                            <a href="<?php echo e(route('fees.reminders')); ?>" class="sidebar-dropdown-item block px-3 py-2 rounded-md text-sm font-medium <?php echo e(request()->routeIs('fees.reminders') ? 'active' : ''); ?>">
                                Reminder List
                            </a>
                        </div>
                    </li>
                    ...
                    <li>
                        <a href="<?php echo e(route('settings.index')); ?>"
                           class="sidebar-item flex items-center space-x-3 px-4 py-3 rounded-lg
                                   <?php echo e(request()->routeIs('settings.index') ? 'active' : ''); ?>">
